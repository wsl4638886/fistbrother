...
//             $res = db('user_service')->where('id='.$info['id'])->setField('end_time',$end_time);
        ...
        if($res){
            ...
            $_SESSION['count'] = $count;
             $str = '服务结束，当前服务用时:'.format_time($end_time-$info['start_time']);
...
//            echo '服务人：'.$user['username'].', 服务项目：'.$sname;
            ...
            $str .= '<br />服务人：'.$user['username'].'<br /> 服务内容：'.$sname;
            global $show_end;
            global $msg;
            $show_end = 1;
            $msg = $str;
...
<body class="loginbg">
    <div class="content">
        ...
        <div class="zctk">
            ...
            <div class="fuwu"><b>您当前选择的服务是：<?php echo $sname;?></b></div>
